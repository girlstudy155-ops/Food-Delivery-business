...
async function fetchUsers() {
  const res = await fetch("https://food-delivery-business-production-00a9.up.railway.app/api/users");
...
async function deleteUser(userId: number) {
  const res = await fetch(`https://food-delivery-business-production-00a9.up.railway.app/api/users/${userId}`, {
    method: "DELETE",
  });
...
async function toggleUserStatus(userId: number, isActive: boolean) {
  const res = await fetch(`https://food-delivery-business-production-00a9.up.railway.app/api/users/${userId}/status`, {
    method: "PATCH",
